...
const data = {
  ...
  twitter:
    chalk.white.bold("https://twitter.com/") + chalk.cyan("mr_vijay_a_"),
  github: chalk.white.bold("https://github.com/") + chalk.green("Vijay-Hozo"),
  linkedin:
    chalk.white.bold("https://linkedin.com/in/") + chalk.blue("mr-vijay"),
  Socials: chalk.white.bold("https://shor.by/") + chalk.cyan("vijay-a"),
  Portfolio:
    chalk.white.bold("https://") + chalk.hex("#97FFF4")("avijay.tech"),
